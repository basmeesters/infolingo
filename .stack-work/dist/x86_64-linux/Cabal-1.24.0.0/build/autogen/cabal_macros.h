...
/* package infolingo-0.1.0.0 */
#define VERSION_infolingo "0.1.0.0"
#define MIN_VERSION_infolingo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "infolingo-0.1.0.0-JV4I9LfmPHYGogeKWylksX"

#define CURRENT_PACKAGE_KEY "infolingo-0.1.0.0-JV4I9LfmPHYGogeKWylksX"
